...
export const navigation = [
  ['Home', '/'], ['GTA Online', '/gta-online'], ['GTA VI', '/gta-6'], ['Weekly Update', '/gta-online/weekly-update'], ['Guides', '/guides'], ['Vehicles', '/gta-online/vehicles'], ['Properties', '/gta-online/properties'], ['Businesses', '/gta-online/businesses'], ['Heists', '/gta-online/heists'], ['News', '/news'], ['Rumors', '/rumors'],
] as const;
